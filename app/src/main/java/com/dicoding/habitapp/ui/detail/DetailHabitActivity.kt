...
class DetailHabitActivity : AppCompatActivity() {
    ...
    private lateinit var detailHabitViewModel: DetailHabitViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detailHabitViewModel = ViewModelProvider(this, factory).get(DetailHabitViewModel::class.java)

        detailHabitViewModel.start(habitId)
        detailHabitViewModel.habit.observe(this) { habit ->
            if (habit != null) {
                selectedHabit = habit
